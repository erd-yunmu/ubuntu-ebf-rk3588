...
## 主要特性
- **系统**：Ubuntu 26.04（resolute）arm64，apt 在线更新内核 / 固件 / 引导
- **内核**：Linux 6.1.114（Rockchip BSP）
- **桌面**：GNOME + GDM3，默认启用 Wayland 会话，内置中文语言包
- **图形**：Mesa（Panfrost / PanVK），OpenGL ES 与 Vulkan 硬件加速
...
## 获取源码
```bash
git clone -b 26.04-panfrost https://github.com/erd-yunmu/ubuntu-ebf-rk3588
